...
|:----------------|------------------:|--------------------------:|-----------------:|-------------------:|--------------------------:|-------------------------:|-------------------------------:|------------------------------:|:-----------------------------------------|:----------------------------------|----------------------:|-----------------------:|----------------------:|---------------------:|:---------------|:--------------------------|
| 2024-10-31      |                 5 |                        36 |                5 |                  0 |                         1 |                        1 |                              1 |                             1 | True                                     | True                              |                     0 |                      0 |                     0 |                    0 | False          | selected-only audit trail |
...
| warning_type                 | severity   | message                                                                                     | requested_month   | resolved_month   | decision_date   | missing_dependency                                        | required_upstream_patch                                                                      |
|:-----------------------------|:-----------|:--------------------------------------------------------------------------------------------|:------------------|:-----------------|:----------------|:----------------------------------------------------------|:---------------------------------------------------------------------------------------------|
| sample_month_resolution      | medium     | requested sample month 2024-11 has no decision row; using available decision month 2024-10  | 2024-11           | 2024-10          | nan             | nan                                                       | nan                                                                                          |
| selected_only_reconstruction | high       | original v8 ledger reports tradable_count=36, but only 5 selected rows can be reconstructed | nan               | nan              | 2024-10-31      | full runtime pred/ranked candidate snapshot was not saved | save v8_2_score_rank_audit_trail.csv inside run_paper_trading_replay when pred/ranked exists |
| selected_only_reconstruction | high       | original v8 ledger reports tradable_count=36, but only 5 selected rows can be reconstructed | nan               | nan              | 2025-03-31      | full runtime pred/ranked candidate snapshot was not saved | save v8_2_score_rank_audit_trail.csv inside run_paper_trading_replay when pred/ranked exists |
| selected_only_reconstruction | high       | original v8 ledger reports tradable_count=36, but only 5 selected rows can be reconstructed | nan               | nan              | 2025-10-31      | full runtime pred/ranked candidate snapshot was not saved | save v8_2_score_rank_audit_trail.csv inside run_paper_trading_replay when pred/ranked exists |
| selected_only_quality_fail   | high       | candidate_count is not greater than selected_count; full unselected candidates are missing  | nan               | nan              | 2024-10-31      | nan                                                       | nan                                                                                          |
| selected_only_quality_fail   | high       | candidate_count is not greater than selected_count; full unselected candidates are missing  | nan               | nan              | 2025-03-31      | nan                                                       | nan                                                                                          |
| selected_only_quality_fail   | high       | candidate_count is not greater than selected_count; full unselected candidates are missing  | nan               | nan              | 2025-10-31      | nan                                                       | nan                                                                                          |
...
- Output directory: `E:\dzhwork\quant\quant_lab\outputs\us_stock_selection\v8_2_score_rank_audit_trail_20260501_111150`
- Zip: `E:\dzhwork\quant\quant_lab\outputs\us_stock_selection\us_stock_selection_quant_lab_v8_2_score_rank_audit_trail_20260501_111150.zip`
